...
// Create the provider
export const KnowledgeBaseContextProvider = ({
  children,
}: {
  children: ReactNode;
}) => {
  ...
  const [files, setFiles] = useState<KnowledgeBaseFile[] | undefined>(
    undefined
  ...
  const [indexerStatus, setIndexerStatus] = useState<IndexerStatus | undefined>(
    undefined
  );
  const [knowledgeBaseLoading, setKnowledgeBaseLoading] =
